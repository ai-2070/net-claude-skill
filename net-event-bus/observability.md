...
Source: `net/crates/net/wire/src/stream.rs:255`.
...
**Alert on `untracked_evictions > 0`** the same way you alert on `events_dropped` — it is the reliable-stream silent-loss signal, and under default backpressure it is otherwise invisible. Source: `net/crates/net/wire/src/reliability.rs:586`.
